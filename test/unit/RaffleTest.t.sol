...
contract RaffleTest is CodeConstants, Test {
    ...
    function testDontAllowPlayersToEnterWhileRaffleIsCalculating() public {
        ...
        raffle.enterRaffle{value: entranceFee}();
        // move time forward
        vm.warp(block.timestamp + interval + 1); // make sure it exceeds interval requirement
        vm.roll(block.number + 1); // at least 1 new block created
    ...
    function testPerformUpkeepUpdatesRaffleStateAndEmitsRequestId() public raffleEntered {
        ...
        // entries[0] from vrfcoordinator
        // topics[0] is event function signature
    ...
    function testFullfillRandomWordsPicksAWinnerResetsAndSendsMoney() public raffleEntered skipFork {
        ...
        Vm.Log[] memory entries = vm.getRecordedLogs();
        bytes32 requestId = entries[1].topics[1];
        // pretends VRF returns random number
